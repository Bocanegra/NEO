...
searchable {
  ...
  compassSettings = [
      'compass.engine.analyzer.default.stopwords' : '+en,quiero,de,un,una,unas,unos,uno,sobre,todo,tambien,tras,otro,algun,alguno,alguna,algunos,algunas,ser,es,esta,como,para,porque,pero,hace,cada,desde,el,la,lo,las,los,su,si,sin,con,busco,end'   
     ]
