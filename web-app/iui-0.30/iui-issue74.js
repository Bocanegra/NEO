...
window.iui =
{
    ...
    showPageByHref: function(href, args, method, replace, cb)
    {
        ...
        req.onreadystatechange = function()
        {
            ...
            {
                if (replace)
                    replaceElementWithSource(replace, req.responseText, (replace.target == "_replaceinner"));
                else
                {
...
addEventListener("click", function(event)
{
    ...
    if (link)
    {
        ...
        else if ((link.target == "_replace") || (link.target == "_replaceinner"))
        {
...
function replaceElementWithSource(replace, source, inner)
{
